...
::: {layout-ncol=2}
![Biodiversity in the Panamanian mangroves](files/images/NEU/mangrove.jpg){ width=10%}

![Tailless Whip Scorpion (*Phrynus Gervaisii*)](files/images/NEU/IMG_2976.jpg){ width=10%}

![Field observations of macroalgal cover in Nahant, MA](files/images/NEU/MSC_quad.jpg){ width=10%}

![Growth experiments with a variety of algae species, including D. japonica](files/images/NEU/MSC_samples.jpg){ width=10%}
