...
![Unicorn clubtail (*Arigomphus villosipes*), note the lil horn](files/images/rbnc/P7020153.jpg){ width=50%}

![Silver-Bordered Fritillary (*Boloria selene)*](files/images/rbnc/silver_bordered_frit.jpg){ width=50%}

![Millipede (*Narceus americanus*)](files/images/rbnc/P8200147.JPG){ width=50%}

![Locust Borer (*Megacyllene robiniae*)](files/images/rbnc/P9020096.JPG){ width=50%}
...
::: {layout-ncol=2}
![Biodiversity in the Panamanian mangroves](files/images/NEU/mangrove.jpg){ width=50%}

![Tailless Whip Scorpion (*Phrynus Gervaisii*)](files/images/NEU/IMG_2976.jpg){ width=50%}

![Field observations of macroalgal cover in Nahant, MA](files/images/NEU/MSC_quad.jpg){ width=50%}

![Growth experiments with a variety of algae species, including D. japonica](files/images/NEU/MSC_samples.jpg){ width=50%}
...
![An ESP laid bare](files/images/WHOI/esp_chris.jpg){ width=50%}

![ESPs were deployed from R/V Tioga](files/images/WHOI/esp_deployment.jpg){ width=50%}


:::

![The joys of putting electronics in the ocean](files/images/WHOI/pump.jpg)
---
